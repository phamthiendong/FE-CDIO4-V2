...
export const BookingCalendar: React.FC<BookingCalendarProps> = ({ doctor, onBook }) => {
  ...
  const handleDateChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    // The valueAsDate property gives a Date object in the local timezone,
    // which is better than parsing the string value which can be UTC.
    const date = e.target.valueAsDate;
    if (date) {
      // Add one day because input type=date can have timezone issues
